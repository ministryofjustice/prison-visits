class Confirmation
  ...
  validates_inclusion_of :outcome, in: [NO_SLOT_AVAILABLE, PRISONER_INCORRECT, NOT_ON_CONTACT_LIST, VISITOR_BANNED, NO_ALLOWANCE, NO_VOS_LEFT, NO_PVOS_LEFT] + %w{slot_0 slot_1 slot_2}
