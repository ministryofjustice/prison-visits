...
describe ZendeskHelper do
  ...
  it "sends a piece of feedback to zendesk" do
    ...
    ZendeskAPI::Ticket.should_receive(:new).with(client, description: 'text', requester: { email: 'email' }, custom_fields: [{id: '23730083', value: 'ref'}, {id: '23757677', value: 'prison_visits'}]).and_return(mock_ticket)
