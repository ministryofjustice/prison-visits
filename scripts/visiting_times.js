...
"HMP LIVERPOOL": {"address":"68 Hornby Road,L9 3DF","email":"socialvisits.liverpool@hmps.gsi.gov.uk","phone":"0151 530 4050"},
...
casper.run(function() {
  ...
  times.forEach(function (times) {
    ...
    prison_data[name].email = details.email.toLowerCase(); // for production
    // prison_data[name].email = 'pvb.'+ name.replace(/ /g, '').toLowerCase() +'@maildrop.dsd.io'; // for staging
